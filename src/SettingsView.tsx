  ...
  return (
    <Flex align="center" justify="between" gap="4">
      <Flex direction="column" gap="1">
        <Text as="label" weight="medium">{props.label}</Text>
        <Text size="2" color="gray">{props.description}</Text>
      </Flex>
    ...
    >
      ...
      <Flex direction="column" gap="5" style={{ "max-width": "480px", margin: "0 auto", width: "100%" }}>
        ...
        <SettingRow
          ...
          description={'When the BPM goes up mid-drill, replay the "Ichi, Ni, So, Re" intro. When off, the repeat starts straight away.'}
